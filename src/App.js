...
function App() {
  ...
  const projects = [
    {name : "Melanoma Cancer Prediction" , year : '2022-2023', projectDescription : 'This project involves developing a Convolutional Neural Network (CNN) model designed to predict melanoma, a type of skin cancer, based on images of skin lesions. The model is trained on a dataset of labeled images to recognize patterns and features indicative of melanoma. The goal is to create a tool that can assist medical professionals in diagnosing skin cancer more accurately and efficiently by analyzing image data, thus improving early detection and treatment outcomes.'},
    {name : "Haxguz - An event management System", year : '2022-2023' ,projectDescription : ' Haxguz is a web application designed for managing and organizing events. Users can create and customize events, invite participants, and monitor event details through an intuitive interface. The application aims to streamline event management processes and provide an efficient platform for both organizers and attendees to interact and manage event-related activities.' },
    {name : 'Consus - A Redefined Comiplation Platform', year : '2023-2024', projectDescription : ' Consus is a web-based platform focused on assessing student performance in programming languages. It provides tools for creating and managing programming tests, running code submissions, and evaluating results. The platform supports various programming languages and offers features for detailed analysis of student code, including automated grading and feedback.' }
  ];

  const members = [
    {name: 'Adesh S S', role: 'Full Stack Developer', quote: "The only way to do great work is to love what you do. – Steve Jobs", src: Logo},
    {name: 'Dinesh P R', role: 'Full Stack Developer', quote: "Strive for progress, not perfection", src: Logo},
    {name: 'Saran S M', role: 'Full Stack Developer', quote: "Trade what you see, not what you think.", src: Logo}
  ];

  const details = [
    {year : '2019 - 2020', qualification : 'SSLC' ,location :"Tagore Matric Higher Secondary School", description : 'During the SSLC (Secondary School Leaving Certificate) examination conducted by the State Government, I achieved a total score of 486 out of 500. This accomplishment reflects a strong academic performance across all subjects, demonstrating proficiency and dedication in my studies.', status : 'Completed' },
    {year : '2021 - 2022', qualification : 'HSC',location :"Tagore Matric Higher Secondary School", description : ' In the Higher Secondary Certificate (HSC) examination, I obtained a commendable score of 550. This result highlights my academic excellence in higher secondary education, where I focused on advanced subjects and developed specialized knowledge in my chosen fields of study.', status : 'Completed' },
    {year : '2022 - 2026', qualification : 'Bachelor of Technology - AIML', location:'Bannari Amman Institute of Technology',description :' This program involves an in-depth study of AI technologies, machine learning algorithms, and data science techniques. My academic journey is marked by a strong commitment to understanding and applying advanced AI concepts, as evidenced by my current CGPA of 7.99.', status : 'Ongoing'}
  ]
